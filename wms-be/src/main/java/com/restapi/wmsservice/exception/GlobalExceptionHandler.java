...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse> handlingOptimisticLockingException(org.springframework.orm.ObjectOptimisticLockingFailureException exception){
        ErrorCode errorCode = ErrorCode.OPTIMISTIC_LOCKING_ERROR;
        return ResponseEntity.status(errorCode.getStatusCode()).body(
                ApiResponse.builder()
                        .code(errorCode.getCode())
                        .message(errorCode.getMessage())
