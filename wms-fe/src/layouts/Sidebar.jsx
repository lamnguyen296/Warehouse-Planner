...
const navItems = [
  ...
  { path: '/warehouse', label: 'Warehouses', icon: Warehouse, permissions: [P.MASTER_DATA_MANAGE] },
  { path: '/location', label: 'Locations', icon: MapPin, permissions: [P.MASTER_DATA_MANAGE] },
  { path: '/item', label: 'Items', icon: Package, permissions: [P.MASTER_DATA_MANAGE] },
  { path: '/bom', label: 'BOM', icon: ListTree, permissions: [P.MASTER_DATA_MANAGE] },
